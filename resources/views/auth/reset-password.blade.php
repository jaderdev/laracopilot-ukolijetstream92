...
<head>
    ...
    <title>Reset Password — MusicMS</title>
...
<div class="w-full max-w-md">
    <div class="text-center mb-8">
        ...
        <h1 class="text-white font-bold text-2xl mt-2">Reset Password</h1>
    </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required
                       class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent">
            </div>
            <button type="submit" class="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-3 rounded-xl font-semibold hover:from-purple-700 hover:to-indigo-700 transition-all shadow-md text-sm">Reset Password</button>
        </form>
    </div>
</div>
</body>
